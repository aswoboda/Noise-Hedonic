...
[Map of sales prices over time about here]
...
\begin{figure}
 \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{../graphs/MCsimResultsSDs500}}
...
\begin{figure}
 \makebox[\textwidth][c]{\includegraphics[width=1.2\textwidth]{../graphs/MCsimResultsSDs650}}
...
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
 & \multicolumn{6}{c}{\textit{Dependent variable: LWR Noise Coefficient}} \\ 
\cline{2-7} 
...
R$^{2}$ & \multicolumn{1}{c}{0.1566} & \multicolumn{1}{c}{0.1722} & \multicolumn{1}{c}{0.3298} & \multicolumn{1}{c}{0.3446} & \multicolumn{1}{c}{0.1700} & \multicolumn{1}{c}{0.1915} \\ 
\hline 
\hline \\[-1.8ex] 
