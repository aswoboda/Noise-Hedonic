...
\end{tabular}
 ...
 \caption*{\small Column (5) displays the proportion of $\hat{\beta}_{LWR}$ that can reject the null hypthesis of $\beta =0$.\\ Column (6) displays the proportion of Monte Carlo simulations with larger standard deviations of the LWR coefficients than $\sigma_{\hat{\beta}}$}
\end{table}
