...
%Reviews of the research by \citet{Bateman2001} found that the negative effect of traffic noise on house prices ranged from 0.08 to 2.22 percent per decibel with a mean around 0.55 percent per decibel, while \citet{Navrud2002} found an average decrease of 0.64 percent per decibel. Much of the 
...
\makebox[\textwidth][c]{\includegraphics[width = 1.2\textwidth]{../graphs/Overview2columnAnnotatedPDF}}
...
\makebox[\linewidth][c]{
\small
\begin{tabular}{lccccccc}%D{.}{.}{1}D{.}{.}{1}D{.}{.}{1}D{.}{.}{1}D{.}{.}{1}D{.}{.}{1}D{.}{.}{1}}
  \hline \hline
...
\scriptsize
  \centering
    \begin{tabular}{lcccccc|c}%D{.}{.}{1}D{.}{.}{1}D{.}{.}{1}D{.}{.}{1}D{.}{.}{1}D{.}{.}{1}|D{.}{.}{1}}
    \\[-1.8ex]\hline 
\hline \\[-1.8ex] 
...
% \begin{figure}
% \makebox[\textwidth][c]{\includegraphics[height = \textheight]{../graphs/DensityPlotsByYear}}
...
\begin{figure}
  \makebox[\textwidth][c]{\includegraphics[width = 1.2\textwidth]{../graphs/GCVbyModelFinal}}
...
\begin{figure}
 \makebox[\textwidth][c]{\includegraphics[height=.9\textheight]{../graphs/MCsim2FinalResults}}
