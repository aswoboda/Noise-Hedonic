...
LWRtimelag = function(my.observation, 
                      Data.Frame, 
                      my.model, my.modelSMALL,
                      kvector,
                      timelag = 12) {
...
#             kvector = KVECTOR
  ...
  # require(fields)
  Data.Frame = subset(Data.Frame, TimePeriod<Data.Frame[as.character(my.observation), "TimePeriod"]+1 & 
    TimePeriod>Data.Frame[as.character(my.observation), "TimePeriod"]-(timelag+1))
...
TimelagReg = function(my.observation, 
                      Data.Frame, 
                      my.model, 
                      timelag = 12) {
