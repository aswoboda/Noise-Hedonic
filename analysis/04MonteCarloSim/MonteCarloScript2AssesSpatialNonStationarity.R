...
KVECTOR = c(4000) # c(200, 400, 650, 1000, 2000, 4000)
...
mcstats = read.csv("analysis/04MonteCarloSim/Revision/Model3/k4000/LWRMonteCarloStats2014-07-06.csv")
...
for (iter in 36:100) { # change to ``iterations'' to get the script to run all the way
  # Do a reshuffle
