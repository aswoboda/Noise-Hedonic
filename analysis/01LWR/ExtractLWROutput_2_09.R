...
load("~/Noise Hedonic Project/Data/R2GIS/LWRoutput/Sales20052010LWRoutput2013-02-09.RData") #Loads LWR output
...
Output <- which(dataNames %in% c("hat.k100","hat.k200", "hat.k500", "hat.k1000", "hat.k4000",  "beta.ACRES.k100", "beta.ACRES.k200", "beta.ACRES.k500", "beta.ACRES.k1000","beta.ACRES.k4000", "beta.MAX.k100", "beta.MAX.k200", "beta.MAX.k500", "beta.MAX.k1000","beta.MAX.k4000","X_Meter", "Y_Meter","SALE_VALUE","logSALE_VA", "UNIQID", "SALE_YR"))
temp = temp[, Output]
...
temp$mfx.MAX.k4000 <- temp$beta.MAX.k4000 * temp$SALE_VALUE
#Land
...
temp$mfx.ACRES.k4000 <- temp$beta.ACRES.k4000 * temp$SALE_VALUE
...
temp$res.k4000 <- temp$logSALE_VA - temp$hat.k4000

dataNames <- names(temp)
output2 <- which(dataNames %in% c("res.k100","res.k200", "res.k500", "res.k1000", "res.k4000","mfx.ACRES.k100", "mfx.ACRES.k200", "mfx.ACRES.k500", "mfx.ACRES.k1000","mfx.ACRES.k4000", "mfx.MAX.k100", "mfx.MAX.k200", "mfx.MAX.k500", "mfx.MAX.k1000","mfx.MAX.k4000","X_Meter", "Y_Meter","SALE_VALUE", "UNIQID", "SALE_YR"))
temp = temp[, output2]
...
write.dbf(fx2005, "../Data/R2GIS/LWRoutput/Sales2005_LWR_02_09.dbf")
write.dbf(fx2006, "../Data/R2GIS/LWRoutput/Sales2006_LWR_02_09.dbf")
write.dbf(fx2007, "../Data/R2GIS/LWRoutput/Sales2007_LWR_02_09.dbf")
write.dbf(fx2008, "../Data/R2GIS/LWRoutput/Sales2008_LWR_02_09.dbf")
write.dbf(fx2009, "../Data/R2GIS/LWRoutput/Sales2009_LWR_02_09.dbf")
write.dbf(fx2010, "../Data/R2GIS/LWRoutput/Sales2010_LWR_02_09.dbf")
