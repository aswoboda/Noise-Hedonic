...
workingdata <- workingdata [-OutlierParcels, ] #Excludes observations that are outliers (n=18668)
...
plot(model.SaleValue2) #Normality issues once again #Observation 4067 large leverage
anova(model.SaleValue2, model.SaleValue1)

workingdata = workingdata [-4067, ] #Removed leveraged observation
...
dwtest (model.logSaleValue1) #autocorrelation # Signs of autocorrelation since DW value is less than 1.5 (1.4861)
