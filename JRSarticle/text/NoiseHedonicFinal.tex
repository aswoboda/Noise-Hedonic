...
\usepackage{alltt}
\usepackage{floatpag} %floatpag.sty file is in the text folder - commands to remove page nos are in first figure
...
\makebox[\textwidth][c]{\includegraphics[width = 1.2\textwidth]{../graphs/Figure01}}
...
\begin{figure}
\makebox[\textwidth][c]{\includegraphics[width = \textwidth]{../graphs/Figure02}}
...
\begin{figure}
  \makebox[\textwidth][c]{\includegraphics[width = 1.2\textwidth]{../graphs/Figure03}}
...
\begin{figure}
 \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{../graphs/Figure04}}
...
\begin{figure}
 \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{../graphs/Figure05}}
...
\begin{figure}
 \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{../graphs/Figure06}}
...
\begin{figure}
 \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{../graphs/Figure07}}
...
\begin{figure}
 \makebox[\textwidth][c]{\includegraphics[height=.9\textheight]{../graphs/Figure08}}
...
\begin{figure}
\makebox[\textwidth][c]{\includegraphics[width = \textwidth]{../graphs/Figure12}}
...
% This file contains the bibliography with proper Journal of Regional Science Formatting
\end{singlespace}
\end{document}
